...
INSERT INTO core_usuario VALUES (2, 'estudiante@gmail.com', 'Renca', 0 , 1, null);
INSERT INTO core_usuario VALUES (3, 'institucion@gmail.com', 'Quilicura', 1 , 1, null);
INSERT INTO core_usuario VALUES (4, 'administrador@gmail.com', 'Ovalle', 2 , 1, null);

INSERT INTO core_parametros VALUES (2, 1, 1000000, 1, 7, 900, 'Ingenieria informatica', 1, 1, 0, 1, 1, 1, 'Universidad');

INSERT INTO core_institucion VALUES (2, 'Universidad de chile', 'Santiago', 1, 7, 3, 'https://uchile.cl', 'default_insti.png', 'Universidad', 1, null);
INSERT INTO core_institucion VALUES (1, 'Duoc', 'Huechuraba', 0, 7, 3, 'https://www.duoc.cl', 'default_insti.png', 'IP', 1, null);
INSERT INTO core_institucion VALUES (3, 'Colo colo', 'Renca', 1, 0, 3, 'https://www.colocolo.cl', 'default_insti.png', 'Universidad', 1, null);
INSERT INTO core_institucion VALUES (4, 'Universidad San Sebastian', 'El centro', 1, 2, 3, 'https://www.uss.cl', 'default_insti.png', 'Universidad', 1, null);
INSERT INTO core_institucion VALUES (5, 'Inacap', 'Providencia', 0, 1, 3, 'https://portal.inacap.cl', 'default_insti.png', 'IP', 1, null);
INSERT INTO core_institucion VALUES (6, 'Universidad catolica', 'Recoleta', 1, 3, 3, 'https://www.uc.cl', 'default_insti.png', 'CFT', 1, null);
INSERT INTO core_institucion VALUES (7, 'Universidad Santo Tomas', 'Quilicura', 1, 4, 3, 'https://www.ust.cl', 'default_insti.png', 'Universidad', 1, null);
INSERT INTO core_institucion VALUES (8, 'Universidad tecnica Federico Santa Maria', 'Huechuraba', 1, 6, 3, 'https://usm.cl', 'default_insti.png', 'Universidad', 1, null);
